...
function wsMessage(data) {
  ...
  switch (packetId) {
    ...
    case 0x40: // set border
      ...
      if (!/MultiOgar|OgarII/.test(reader.getStringUTF8()) || stats.pingLoopId)
        break;
...
function init() {
    ...
    setTimeout(() => {
      setInterval(() => {
        ...
        localStorage.setItem(
          "doublesplit",
          document.getElementById("doublesplit").value
        );
        localStorage.setItem("freeze", document.getElementById("freeze").value);
        localStorage.setItem(
          "triplesplit",
          document.getElementById("triplesplit").value
        );
        localStorage.setItem(
          "16split",
          document.getElementById("16split").value
        );
        localStorage.setItem(
          "botFeed",
          document.getElementById("botFeed").value
        );
        localStorage.setItem(
          "botSplit",
          document.getElementById("botSplit").value
        );
        localStorage.setItem(
          "botFreeze",
          document.getElementById("botFreeze").value
        );
        localStorage.setItem(
          "botDoubleSplit",
          document.getElementById("botDoubleSplit").value
        );
        localStorage.setItem(
          "botTripleSplit",
  ...
  (function load() {
    setTimeout(() => {
      ...
      let Fz = localStorage.getItem("freeze");
      let tS = localStorage.getItem("triplesplit");
      let split16 = localStorage.getItem("16split");
      let bF = localStorage.getItem("botFeed");
      let bFz = localStorage.getItem("botFreeze");
      let bS = localStorage.getItem("botSplit");
      ...
      document.getElementById("botFeed").value = bF;
      document.getElementById("botSplit").value = bS;
      document.getElementById("botFreeze").value = bFz;
